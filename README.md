...
- 🔍 **中英文支持** - 同时支持中文和英文搜索
- 🤖 **多客户端支持** - 兼容 Claude Code、OpenCode、OpenClaw、Cline 等 AI 编码助手
...
| `--openclaw` | 安装到 OpenClaw (`~/.openclaw/workspace/skills/`) |
...
安装后，在 Claude Code / OpenCode / OpenClaw 等助手中可以直接请求网络搜索：
